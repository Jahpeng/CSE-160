...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        const x = (o1[1]*o2[2]) - (o1[2]*o2[1]);
        const y = (o1[2]*o2[0]) - (o1[0]*o2[2]);
        const z = (o1[0]*o2[1]) - (o1[1]*o2[0]);
    ...
    magnitude() {
        // Insert your code here.
        const curr = this.elements;
        let m = Math.sqrt((curr[0]*curr[0]) + (curr[1]*curr[1]) + (curr[2]*curr[2])); // Modify this line to calculate this vector's magnitude.
