...
function renderAllShapes(){
  ...
  //neck.matrix.rotate(45*Math.sin(g_seconds),1,0,0); //for animation
  //if(g_animation){
  //  neck.matrix.rotate(45*Math.sin(g_seconds),1,0,0);
  //} else{
  //  neck.matrix.rotate(g_neck,1,0,0);
  //}
  neckCoord = new Matrix4(neck.matrix)
  neck.matrix.scale(0.1,0.3,0.1);
  //neck.matrix.rotate(-15,1,0,0);
  //neck.matrix.rotate(g_test,1,0,0);
  neck.render();
  // HEAD
  var head = new Cube();
  head.color = [.15,.75,.45,1.0];
  head.matrix = new Matrix4(neckCoord);
  //head.matrix = bodyCoord; //testing
  ...
  //head.matrix.rotate(-g_headSlide,0,0,1); //for slider
  //var headCoord = new Matrix4(head.matrix)
  head.render();
  ...
  //eyeL.matrix.translate(0.12,0.45,-0.2);
  eyeL.matrix = new Matrix4(headCoord); //headCoord;
  //eyeL.matrix.translate(0.12,0.6,-0.2);
  ...
  //eyeR.matrix.translate(-0.22,0.6,-0.2); 
  //eyeR.matrix.translate(0.3,0.45,-0.2); 
  ...
  //body.matrix.rotate(30,-30,0,1); //original 
  //body.matrix.rotate(g_test,-30,0,1); //testing body rotation
  ...
  //wingL.matrix.translate(-0.28,-0.6,0.35);
  ...
  //wingR.matrix.translate(0.16,-0.6,0.35);
  //wingR.matrix.rotate(30,-30,0,1);
  ...
  //var arm = new Cube();
  //arm.color = [1,1,0,1];
  //arm.matrix.translate(.7,0.0,0.1);
  //arm.matrix.rotate(45,0,0,1);
  //arm.matrix.scale(0.25,.7,0.5);
  //arm.render();

  //var body2 = new Cube();
  //body2.color = [1.0,0.0,1.0,1.0];
  //body2.matrix.translate(.25,-.5,0.25);
  //body2.matrix.scale(0.5,1.0,0.4);
  //body2.render();
